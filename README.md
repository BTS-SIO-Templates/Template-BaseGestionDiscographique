...
- il lance le chargement des dépendances avec `composer install` 
...
- il lance les fixtures si elles ne sont pas déja créées ou si vous le demandez avec `php bin/console doctrine:fixtures:load --no-interaction` 
